 ...
 * cookie
 */
$cfg['blowfish_secret'] = 'xsVysmNw4fBk6VAZnGBk6zzF8IScSw7M'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
$i++;
$cfg['Servers'][$i]['host']          = '10.100.51.13'; // MySQL hostname or IP address
